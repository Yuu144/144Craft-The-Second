ServerEvents.recipes(event => {
    ...
    event.remove({ mod: 'industrialforegoing', output: 'mekanism:dust_lithium' })
    ...
    event.shaped('mekanism:pressurized_reaction_chamber', [
        ...
        C: 'modern_industrialization:titanium_large_plate',
        D: 'modern_industrialization:titanium_gear',
